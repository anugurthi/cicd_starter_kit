...
echo "📚 Next steps:"
echo ""
echo "1️⃣  Start Hour 1:"
echo "   $ open hour-1/README.md"
echo "   Or visit: http://localhost:5000 after running the app"
echo ""
echo "2️⃣  Run the application:"
echo "   $ cd app && python3 app.py"
echo ""
echo "3️⃣  Follow the guided workshop:"
echo "   - Hour 1: Local Development (60 min)"
echo "   - Hour 2: CI/CD Pipeline (60 min)"
echo ""
echo "4️⃣  Need help?"
echo "   Check reference/CHEATSHEET.md"
echo ""
echo "======================================"
